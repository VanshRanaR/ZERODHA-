        ...
        <div className="row p-5">
            ...
            <div className="col-6 p-5">
                ...
                <div className='text-center p-5' >
                    <a href='' className='mx-5' style={{textDecoration:"none"}}>Explore our product{" -->"} <i class="fa fa-long-arrow-right" arial-hidden="true"></i></a>
                    <a href=''style={{textDecoration:"none"}}>Try kite dem {" -->"}  <i class="fa fa-long-arrow-right" arial-hidden="true"></i></a>
                </div>
            </div>
        </div>
       </div>
